...
/// <summary>
/// Represents a fox m_agent in the simulation, capable of performing various behaviors such as eating, drinking, reproducing, and dying.
/// </summary>
...
public class FoxAgent : MonoBehaviour, IEat, IReduceVitals, ILookForFood, ILookForWater, IDrink, ILookForMate, IDie {
    ...
    [SerializeField] private FoxState m_foxState;
    ...
    public void lookForMate() {
        ...
        m_closestMate.GetComponent<FoxAgent>().waitForMate();
        m_foxState = FoxState.Reproduce;
    }
    ...
    public void moveTorwardsMate() {
        ...
        if (Vector3.Distance(transform.position, m_closestMate.transform.position) <= m_agent.reproductionDistance) {
            ...
            m_closestMate.GetComponent<FoxAgent>().resetState();
            return;
        }
        m_movementManager.setMovementState(MovementState.Arriving);
    }
    ...
    private bool isActing() {
        return m_foxState == FoxState.Eating ||
            m_foxState == FoxState.Drinking ||
            m_foxState == FoxState.Reproduce;
    }
    ...
    /// <summary>
    /// Enum defining the possible states of the fox m_agent.
    /// </summary>
